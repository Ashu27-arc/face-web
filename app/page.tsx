      ...
      <section className="py-24">
        <div className="glass p-16 rounded-3xl relative overflow-hidden">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-12 text-center relative z-10">
            ...
            <div className="space-y-2">
              <div className="text-6xl font-bold gradient-text mb-3">98%</div>
              <div className="text-slate-300 text-lg font-medium">Client Satisfaction</div>
            </div>
            <div className="space-y-2">
              <div className="text-6xl font-bold gradient-text mb-3">24/7</div>
            ...
            <div className="space-y-2">
              ...
              <div className="text-slate-300 text-lg font-medium">Team Members</div>
            </div>
          </div>
        </div>
      </section>
